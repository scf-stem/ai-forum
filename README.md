...
│   ├── requirements.txt
│   └── .env.example               # 环境变量示例
├── forum-database/                # 数据库初始化
│   ├── init.sql                   # PostgreSQL 初始化脚本
│   └── seed_boards.py             # 版块种子数据
├── docker-compose.yml             # 一键启动 PostgreSQL + Redis
├── ai-developer-forum-prd/        # 产品需求文档（PRD，HTML + Mermaid 图表）
├── ai-developer-forum-prototype/  # 高保真原型（9 个页面）
...
| 文档 | 路径 | 说明 |
|---|---|---|
| 产品需求文档 (PRD) | [`ai-developer-forum-prd/`](./ai-developer-forum-prd/) | 完整 PRD（HTML + Mermaid 图表 + ECharts） |
| 高保真原型 | [`ai-developer-forum-prototype/`](./ai-developer-forum-prototype/) | 9 个页面原型 |
| 需求汇总 | [`ai-forum-requirement-summary/`](./ai-forum-requirement-summary/) | 需求总结文档 |
| 信息架构 | [`information-architecture.md`](./information-architecture.md) | 页面清单与跳转关系 |
...
| 项目 | 文件 | 说明 |
|---|---|---|
| 贪吃蛇游戏 | [`snake-game.html`](./snake-game.html) | 赛博朋克霓虹风格，支持四难度与穿墙模式 |
| 天气应用 | [`weather-app.html`](./weather-app.html) | 天气查询应用 |
| 记账工具 | [`accounting-tool.html`](./accounting-tool.html) | 个人记账工具 |
| 个人作品集 | [`portfolio/`](./portfolio/) | Vite + React 作品集站点 |

---

## 协作规范

本仓库的 AI Agent 协作规范定义于 [`AGENTS.md`](./AGENTS.md)，核心规则：
